...
root_name=['/hexagon/work/milicak/RUNS/gold/neptune/'];

project_name=['Exp01.1']
foldername=[root_name project_name '/'];
filename=[foldername 'prog_1.nc']; 
grdname2=[foldername 'OUT/ocean_geometry.nc'];
...
BPE(end+1)=bpe_calc(T,S,dz,area,H,h_sorted,vol_sorted,grav);
tim3=toc;tic
