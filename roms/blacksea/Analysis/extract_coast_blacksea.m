...
switch job,
  case 'seagrid'
    Oname='blacksea_coast.mat';
  case 'ploting'
    Oname='blacksea_inter.cst';
end,

 GSHHS_DIR='/home/mil021/ocean/GSHHS/Version_1.2/';
...
Llon=27.5;               % Left   corner longitude     % BlackSea region
...
%%% Mehmet %%%%
%display(' there is something wrong around lat=74, so I remove them, MI')
%C.lat(C.lat==74)=NaN;
