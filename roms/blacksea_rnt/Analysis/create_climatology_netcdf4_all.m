function [status]=create_climatology_netcdf4_all(grd,clmfile)
...
zetatime_dimid=netcdf.defDim(ncid,'zeta_time',25);
v2dtime_dimid=netcdf.defDim(ncid,'v2d_time',25);
v3dtime_dimid=netcdf.defDim(ncid,'v3d_time',25);
temptime_dimid=netcdf.defDim(ncid,'temp_time',25);
salttime_dimid=netcdf.defDim(ncid,'salt_time',25);
...
temp_varid=netcdf.defVar(ncid,'temp','float',[nir_dimid njr_dimid nzr_dimid temptime_dimid]);
netcdf.putAtt(ncid,temp_varid,'long_name','potential temperature climatology');
netcdf.putAtt(ncid,temp_varid,'units','C');
netcdf.putAtt(ncid,temp_varid,'coordinates','lon_rho lat_rho');
...
vvel_varid=netcdf.defVar(ncid,'v','float',[niv_dimid njv_dimid nzr_dimid v3dtime_dimid]);
netcdf.putAtt(ncid,vvel_varid,'long_name','v-momentum component climatology');
netcdf.putAtt(ncid,vvel_varid,'units','m s-1');
netcdf.putAtt(ncid,vvel_varid,'coordinates','lon_v lat_v');
...
salt_varid=netcdf.defVar(ncid,'salt','float',[nir_dimid njr_dimid nzr_dimid salttime_dimid]);
netcdf.putAtt(ncid,salt_varid,'long_name','salinity climatology');
netcdf.putAtt(ncid,salt_varid,'units','psu');
netcdf.putAtt(ncid,salt_varid,'coordinates','lon_rho lat_rho');
