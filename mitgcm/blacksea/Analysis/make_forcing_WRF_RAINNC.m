clear all
rho0 = 1e3;
mm2m = 1e-3; %mm to meter
% variable names
fname = '/media/milicak/DATA1/datasets/WRF/BSA03/RAIN_full.nc'
varname = 'RAINNC'
...
for itr= 1:365*dataperday %2011
    index = index+1;
    var1 = double(ncread(fname,varname,[1 1 itr],[Inf Inf 1]));
    var2 = double(ncread(fname,varname,[1 1 itr+1],[Inf Inf 1]));
    var = rho0*mm2m*(var2-var1)/(freqdata*3600); 
