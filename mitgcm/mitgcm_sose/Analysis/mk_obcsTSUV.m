...
woatname = '/okyanus/users/milicak/dataset/soda3.7.2shrt/ocn/ORIGINAL/ocean/obcs/2007_2013_temp_northernBC.nc';
woasname = '/okyanus/users/milicak/dataset/soda3.7.2shrt/ocn/ORIGINAL/ocean/obcs/2007_2013_salt_northernBC.nc';
woauname = '/okyanus/users/milicak/dataset/soda3.7.2shrt/ocn/ORIGINAL/ocean/obcs/2007_2013_u_northernBC.nc';
woavname = '/okyanus/users/milicak/dataset/soda3.7.2shrt/ocn/ORIGINAL/ocean/obcs/2007_2013_v_northernBC.nc';
...
lonc = ncread('/okyanus/users/milicak/dataset/soda3.7.2shrt/ocn/ORIGINAL/ocean/soda3.7.2shrt_5dy_ocean_or_2013_12_20.nc','xt_ocean'); 
...
bathyfile = '/okyanus/users/milicak/Analysis/mitgcm/mitgcm_sose/Analysis/BATHY_4320x640_SO_9km_GEBCO_v2.bin';
...
for k=1:size(tempc,3)                                                              
    ...
    uvelc(:,:,k) = get_missing_val(lonc,zrc,squeeze(uvelc(:,:,k)),NaN,0,0);
    vvelc(:,:,k) = get_missing_val(lonc,zrc,squeeze(vvelc(:,:,k)),NaN,0,0);
end                                                                             
