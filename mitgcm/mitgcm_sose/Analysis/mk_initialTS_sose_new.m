...
tmp_out = ['sose20090901_Temp.bin'] ; 
slt_out = ['sose20090901_Salt.bin'] ; 

% initial conditions from 2009 September since 2005 there is Weddell Sea Polynya
tempc = rdmds('/okyanus/users/milicak/dataset/SOSE/THETA_mnthlyBar',100,'rec',57);
saltc = rdmds('/okyanus/users/milicak/dataset/SOSE/SALT_mnthlyBar',100,'rec',57);
