...
project_name = ['mix_eff']

project_name1 = ['/hexagon/work/milicak/RUNS/mitgcm/' project_name '/input_exp1.5/'];
...
switch title
    case 'lock_exchange'
        ...
        % Density difference between two basins Re_h=125,    500,      1000,    2500,  5000,   10000
        delta_rho = 2.5484;                     %3.98e-4; 0.006371; 0.025484; 0.1593, 0.6371, 2.5484

        % temp coeff for linear equation of state
        alpha = 0.2;

        % Dimensions of grid in x y z
        nz = 32*20; %24*6; %24 procs for gaea c1 nz=144 for Re_h=125,500,1000 |  nz=288 for Re_h=2500 | nz=432 for Re_h=5000 | nz=640 for Re_h=10000 for 32 procs for gaea c2
