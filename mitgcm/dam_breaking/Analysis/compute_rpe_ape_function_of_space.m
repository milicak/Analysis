...
if time>0
  ...
  if(project_name=='Exp01.1')
    ...
    save(['/fimm/work/milicak/RUNS/Analysis/mitgcm/dam_breaking/Analysis/matfiles/' filename],'pe','rpe','ape','ape_new','dnm_ape','dnm_pe','dnm_rpe','flxBPEx','flxBPEy','flxBPEz','rhow','irr_mix','time_days','flxAPEz','flxPEz','wrhoz_zdz')
  end
end
end
