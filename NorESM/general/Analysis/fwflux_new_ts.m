...
expr(1)=struct('name','NAER1850CNOC_f19_g16_03', ...
               ...
               'path','/fimm/work/milicak/mnt/norstore/NS2345K/noresm/cases/NAER1850CNOC_f19_g16_03/ocn/hist');
expr(2)=struct('name','NBF1850OC_f19_tn11_test_GM_02', ...
               'name_disp','NBFGM-02', ...
               'first_year',1, ...
               'last_year',50, ...
               'display_first_year',1, ...
               ...
               'monthly_diagnostics',1,...
               'path','/hexagon/work/milicak/archive/NBF1850OC_f19_tn11_test_GM_02/ocn/hist');
expr(3)=struct('name','NBF1850OC_f19_tn11_01', ...
               'name_disp','NBFctrl', ...
               'first_year',1, ...
               'last_year',50, ...
               'display_first_year',1, ...
               ...
               'basin_mask_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/mertraoceans.dat', ...
               'monthly_diagnostics',1,...
               'path','/fimm/work/milicak/mnt/norstore/NS2345K/noresm/cases/NBF1850OC_f19_tn11_01/ocn/hist');
expr(4)=struct('name','NBF1850OC_f19_tn11_test_GM_05', ...
               'name_disp','NBFGM-05', ...
               'first_year',1, ...
               'last_year',50, ...
               'display_first_year',1, ...
               ...
               'basin_mask_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/mertraoceans.dat', ...
               'monthly_diagnostics',1,...
               'path','/hexagon/work/milicak/archive/NBF1850OC_f19_tn11_test_GM_05/ocn/hist');
expr(5)=struct('name','NBF1850OC_f19_tn11_test_GM_06', ...
               'name_disp','NBFGM-06', ...
               'first_year',1, ...
               'last_year',50, ...
               'display_first_year',1, ...
               ...
               'basin_mask_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/mertraoceans.dat', ...
               'monthly_diagnostics',1,...
               'path','/hexagon/work/milicak/archive/NBF1850OC_f19_tn11_test_GM_06/ocn/hist');
 expr(6)=struct('name','NBF1850_f19_tn11_Xmas_SolarAngle', ...
                'name_disp','NBF-Xmas', ...
                'first_year',1, ...
                'last_year',50, ...
                'display_first_year',1, ...
                ...
                'basin_mask_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/mertraoceans.dat', ...
                'monthly_diagnostics',1,...
                'path','/fimm/work/milicak/mnt/norstore/NS4659K/chuncheng/cases_test_Xmas2015/NBF1850_f19_tn11_Xmas_SolarAngle/ocn/hist');
                %'path','/fimm/work/milicak/mnt/norstore/NS4659K/chuncheng/cases_test_vilje/N1850_f19_tn11_default_cguo_pecountX/ocn/hist');
expr(7)=struct('name','N1850_f19_tn11_01_default', ...
               'name_disp','N1850_det', ...
               'first_year',1, ...
               'last_year',50, ...
               'display_first_year',1, ...
               ...
               'basin_mask_file','/hexagon/work/shared/noresm/inputdata/ocn/micom/tnx1v1/20120120/mertraoceans.dat', ...
               'monthly_diagnostics',1,...
               'path','/fimm/work/milicak/mnt/norstore/NS2345K/noresm/cases/N1850_f19_tn11_01_default/ocn/hist');
...
%               'name_disp','NorESM\_c1.2-LM with CLM4.5', ...
%               'first_year',1, ...
%               'last_year',30, ...
%               'display_first_year',1, ...
%               'add_to_expr',[], ...
...
%expr(3)=struct('name','N1850C5OL32_27may2016_f19_tn11', ...
...
%%              'path','/fimm/work/matsbn/hexagon-work/matsbn/noresm/N1850C5OL32_27may2016_f19_tn11/run');
%%               'path','/fimm/work/matsbn/norstore-NS2345K/noresm/cases/N1850C5OL32_27may2016_f19_tn11/ocn/hist');
%
%              'first_year',171, ...
%              'first_year',171, ...
%              'first_year',171, ...
...
for nexp=1:length(expr)
  ...
  if exist(['matfiles/fwflux_new_ts_' expr(nexp).name '.mat'])
    load(['matfiles/fwflux_new_ts_' expr(nexp).name '.mat'])
  else
    year_list=[];
    fwflux_global=[];
    fwflux_atl=[];
  ...
  if isempty(year_list)||any(diff(year_list)~=1)|| ...
    ...
    if years_added
      ...
      save(['matfiles/fwflux_new_ts_' expr(nexp).name '.mat'], ...
    ...
    while iyl<length(year_list)
      ...
      if     plot_mode==0
        ph(nexp)=plot(time,fwflux_global_yr(1,iyf:iyl)*1e-9, ...
                 ...
                 plot(time,fwflux_global_yr(6,iyf:iyl)*1e-9, ...
                      '-','LineWidth',linewidth,'Color','y');
                 plot(time,fwflux_global_yr(7,iyf:iyl)*1e-9, ...
      ...
      elseif plot_mode==2
        aa(nexp,:)=0.0*fwflux_pac30_yr(1,iyf:iyl)*1e-9+1.0*fwflux_ind30_yr(1,iyf:iyl)*1e-9;
        % ph(nexp)=plot(time,fwflux_pac30_yr(1,iyf:iyl)*1e-9+fwflux_ind30_yr(1,iyf:iyl)*1e-9, ...
        %               '-','LineWidth',linewidth,'Color',expr(nexp).color);
...
% h=legend(expr(legend_list).name_disp,'location','Best');
  ...
  set(gca,'XTick',1:7,'XTickLabel', ...
      {'net','rain','snow','evap','liq runoff','frz runoff','fwf ice'})
...
for nexp=length(expr):-1:1
  if expr(nexp).print
    ...
    print (gcf,'-dpng', '-r300', [picpath '/' expr(nexp).name '/fwflux_new_' ...
