...
modelname = 'ncar-pop';
gridname = '/export/grunchfs/unibjerknes/milicak/bckup/noresm/CORE2/Arctic/DATA/ncar-pop/areacello_fx_CCSM4_piControl_r0i0p0.nc';

lon = ncread(gridname,'lon');
lat = ncread(gridname,'lat');
area = ncread(gridname,'areacello');
