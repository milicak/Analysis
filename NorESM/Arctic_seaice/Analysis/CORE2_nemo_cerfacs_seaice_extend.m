...
modelname = 'nemo-cerfacs';
gridname = '/export/grunchfs/unibjerknes/milicak/bckup/noresm/CORE2/Arctic/DATA/nemo-cerfacs/CERFACS_cell_area.nc'; 

lon = ncread(gridname,'lon');
lat = ncread(gridname,'lat');
area = ncread(gridname,'Cell_area');
...
fname = '/CERFACS_seaice_concentration.nc';
icevariable = 'CCice_Cy5';
