...
modelname = 'mir-data';
gridname = '/export/grunchfs/unibjerknes/milicak/bckup/noresm/CORE2/Arctic/DATA/mir-data/lonlat_t.nc'; 
gridname2 = '/export/grunchfs/unibjerknes/milicak/bckup/noresm/CORE2/Arctic/DATA/mir-data/bathymetry_t.nc'; 

lon = ncread(gridname,'glon_t');
lat = ncread(gridname,'glat_t');
area = ncread(gridname2,'area_t');
area(area<0)=0;
