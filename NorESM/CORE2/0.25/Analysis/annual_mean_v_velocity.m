...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/0.25/' expid '_v_velocity_annual_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
...
netcdf.putAtt(ncid,vlon_varid,'bounds','lonu_bounds');
...
netcdf.putAtt(ncid,vlat_varid,'bounds','latu_bounds');
...
netcdf.putAtt(ncid,vvel_varid,'long_name','Velocity y-component');
