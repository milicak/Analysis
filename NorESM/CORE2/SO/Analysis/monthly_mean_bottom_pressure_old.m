% this subroutine computes monthly mean bottompress
clear all
...
% Create netcdf file.
ncid=netcdf.create([expid '_bottompress_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
