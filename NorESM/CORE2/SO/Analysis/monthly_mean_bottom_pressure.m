...
% Create netcdf file.
%ncid=netcdf.create([expid '_bottom_pressure_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
%ncid=netcdf.create(['/work/milicak/RUNS/noresm/CORE2/CORE2_files/SSH/' expid '_bottom_pressure_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/SSH/' expid '_bottom_pressure_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
