...
time_str = 181; % initial time to start averaging
time_end = 200; % final time to start averaging
months_end = 12; % the variable averaged through whole year (12 months)

hist_file = [folder_name project_name '.micom.hm.0001-01.nc'];
depth=nc_varget(hist_file,'depth');
