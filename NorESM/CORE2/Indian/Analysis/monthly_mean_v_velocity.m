% this subroutine computes annual mean v-velocity
clear all
...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Indian/' expid '_v_velocity_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
