% this subroutine computes pendatal mean temp
clear all
...
prefix=['/bcmhsm/' userid '/archive/' expid '/ocn/hist/' expid '.micom.hm.'];
...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/kepsilon/' expid '_temperature_annual_' num2str(fyear) '-' num2str(lyear2) '.nc'],'NC_CLOBBER');
