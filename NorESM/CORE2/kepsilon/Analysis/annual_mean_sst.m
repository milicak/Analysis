...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/kepsilon/' expid '_sst_annual_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
...
netcdf.putAtt(ncid,sst_varid,'units','C');
