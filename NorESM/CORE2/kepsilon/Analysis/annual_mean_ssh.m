...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/kepsilon/' expid '_ssh_annual_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
...
for year=fyear:lyear
  ...
  n=n+1;
    for month=1:12
      ...
      ssh=ssh+tmp(:,1:end-1,:).*months2days(month);
