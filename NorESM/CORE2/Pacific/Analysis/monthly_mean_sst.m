...
% Create netcdf file.
%ncid=netcdf.create([expid '_sst_annual_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Pacific/' expid '_sst_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
