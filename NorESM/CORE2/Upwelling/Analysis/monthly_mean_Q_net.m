...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Upwelling/' expid '_Q_net_swa_nsf_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
...
netcdf.putAtt(ncid,Qnsf_varid,'long_name','Net surface nonsolar heat flux');
...
netcdf.putAtt(ncid,Qswa_varid,'long_name','Net surface shortwave flux');
