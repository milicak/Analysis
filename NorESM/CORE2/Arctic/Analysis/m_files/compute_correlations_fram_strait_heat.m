...
a1=fram_heat_north_ncar(end-49:end)+fram_heat_south_ncar(end-49:end);
a2=fram_heat_north_mom(end-49:end)+fram_heat_south_mom(end-49:end);
a3=fram_heat_north_mri_free(end-49:end)+fram_heat_south_mri_free(end-49:end);
a4=fram_heat_north_mri_data(end-49:end)+fram_heat_south_mri_data(end-49:end);
a5=fram_heat_north_hycom(end-49:end)+fram_heat_south_hycom(end-49:end);
a6=fram_heat_north_hycom2(end-49:end)+fram_heat_south_hycom2(end-49:end);
a7=fram_heat_north_noresm(end-49:end)+fram_heat_south_noresm(end-49:end);
a8=fram_heat_north_cnrm(end-49:end)+fram_heat_south_cnrm(end-49:end);
a9=fram_heat_north_gold(end-49:end)+fram_heat_south_gold(end-49:end);
a10=fram_heat_north_cerfacs(end-49:end)+fram_heat_south_cerfacs(end-49:end);
a11=fram_heat_north_fesom(end-49:end)+fram_heat_south_fesom(end-49:end);
a12=fram_heat_north_geomar(end-49:end)+fram_heat_south_geomar(end-49:end);
a13=fram_heat_total_cmcc(end-49:end);
a14=fram_heat_total_noc(end-47:end);
dnm(1:length(a14))=a14;
dnm(end+1)=a14(end);dnm(end+1)=a14(end);
a14=dnm;
%a15=fram_heat_total_mom_0_25(end-49:end);
%a15=fram_heat_total_mom_0_25(end-coef1-33:end-33);
a15=fram_heat_total_mom_0_25(278:327);
...
fram_heat_corr=corr(A);
fram_heat_corr_LP=corr(AL);
fram_heat_corr_HP=corr(AH);
for k=1:15
  fram_heat_corr(k,k+1:end)=NaN;
  fram_heat_corr_LP(k,k+1:end)=NaN;
  fram_heat_corr_HP(k,k+1:end)=NaN;
end
keyboard

figure(1)
imagescwithnan(flipud(fram_heat_corr),jet,[.7 .7 .7])
...
figure(2)
imagescwithnan(flipud(fram_heat_corr_LP),jet,[.7 .7 .7])
set(gca,'yticklabel',{'14' '12' '10' '8' '6' '4' '2'})
...
caxis([-0.83 1])
printname=['paperfigs2/fram_heat_corr_low']
print(2,'-depsc2',printname)

figure(3)
imagescwithnan(flipud(fram_heat_corr_HP),jet,[.7 .7 .7])
set(gca,'yticklabel',{'14' '12' '10' '8' '6' '4' '2'})
printname=['paperfigs2/fram_heat_corr_high']
print(3,'-depsc2',printname)

close all
marpcolor((fram_heat_corr_LP));shf
set(gca,'yticklabel',{'2' '4' '6' '8' '10' '12' '14'})
set(gca,'ytick',[2.5:2:16])                           
set(gca,'xtick',[2.5:2:16])
set(gca,'xticklabel',{'2' '4' '6' '8' '10' '12' '14'})
printname=['paperfigs2/fram_heat_corr_low_v2']
