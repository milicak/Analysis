...
filename_s='/work/milicak/RUNS/noresm/CORE2/Arctic/DATA/nemo-cerfacs/CERFACS_TSUV_month1.nc';
filename_t='/work/milicak/RUNS/noresm/CORE2/Arctic/DATA/nemo-cerfacs/CERFACS_TSUV_month1.nc';
lon=ncgetvar(filename_t,'lon');
lat=ncgetvar(filename_t,'lat');
zt=ncgetvar(filename_t,'gdept');

salt=ncgetvar(filename_s,'S_month1_Cy1');
temp=ncgetvar(filename_t,'T_month1_Cy1');
...
save('matfiles/nemo_cerfacs_initial_eurasia_basin_profiles.mat','temp_eurasia','salt_eurasia','zt')
