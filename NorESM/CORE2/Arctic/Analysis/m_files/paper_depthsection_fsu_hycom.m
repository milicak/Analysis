...
filename_u='/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/fsu-hycom/TSuv_pentadals_glb1x3.nc';
filename_v='/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/fsu-hycom/TSuv_pentadals_glb1x3.nc';
...
printname=['paperfigs2/fsu_hycom_salt_horizontal_section_' num2str(sec_depth)];
...
m_grid('xtick',[-120 -60 0 60 120])
     ...
     set(gca,'fontsize',fontsize)
     set(gcf,'color','w');
printname=['paperfigs2/fsu_hycom_temp_horizontal_section_' num2str(sec_depth)];
...
printname=['paperfigs/fsu_hycom_uv_horizontal_section_' num2str(sec_depth)];
print(1,'-depsc2','-r150',printname)
close all
