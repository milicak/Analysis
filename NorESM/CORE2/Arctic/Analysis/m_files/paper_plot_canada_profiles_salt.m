...
load color_15
dnm1=interp1(out.woa.zt,out.woa.salt_canada,zr);

[P_scaled,Ptick,Pticklabel,Plim,zsplit]=rescale_depth(out.woa.zt);
plot(out.woa.salt_canada,P_scaled,'k--','linewidth',2);
set(gca,'ylim',Plim,'ytick',Ptick,'yticklabel',-Pticklabel);
ylim([0 1200])
set(gca,'ydir','reverse');
hold on

dnm=interp1(out.fesom.zt,out.fesom.salt_canada,zr);
...
[P_scaled,Ptick,Pticklabel,Plim,zsplit]=rescale_depth(out.woa.zt);
line(out.woa.salt_canada,P_scaled,'Color','k','linestyle','--','linewidth',2,'Parent',ax(2));
...
%set(ax(1),'box','off')
%set(ax(2),'box','off')
%printname=['paperfigs/canada_basin_salt_profilesv3'];
%printname=['paperfigs2/canada_basin_salt_profilesv3'];
printname=['paperfigs2/canada_basin_salt_profilesv4'];
...
printname=['paperfigs/canada_basin_salt_profilesv2'];
