...
a14=dnm;
%a15=fram_volume_total_mom_0_25(end-coef1:end);
%a15=fram_volume_total_mom_0_25(end-coef1-33:end-33);
a15=fram_volume_total_mom_0_25(278:327);
...
fram_volume_corr=corr(A);
fram_volume_corr_LP=corr(AL);
fram_volume_corr_LP2=corr(AL2);
fram_volume_corr_HP=corr(AH);
for k=1:15
  fram_volume_corr(k,k+1:end)=NaN;
  fram_volume_corr_LP(k,k+1:end)=NaN;
  fram_volume_corr_LP2(k,k+1:end)=NaN;
  fram_volume_corr_HP(k,k+1:end)=NaN;
end
keyboard

figure(1)
imagescwithnan(flipud(fram_volume_corr),jet,[.7 .7 .7])
...
hh=text(11,10.5,{'1:AWI-FESOM','2:Bergen','3:CERFACS','4:CMCC','5:CNRM', ...
       '6:FSU-HYCOM','7:FSU-HYCOMv2','8:GFDL-GOLD', '9:GFDL-MOM','10:Kiel-ORCA05', ...
       '11:MOM0.25','12:MRI-A','13:MRI-F','14:NCAR','15:NOC',},'fontsize',14)
set(hh,'BackgroundColor','w')

figure(2)
imagescwithnan(flipud(fram_volume_corr_LP),jet,[.7 .7 .7])
set(gca,'yticklabel',{'14' '12' '10' '8' '6' '4' '2'})
%hh=text(11,10.5,{'1:NCAR','2:GFDL-MOM','3:MRI-F','4:MRI-A','5:FSU-HYCOM','6:FSU-HYCOMv2','7:BERGEN','8:CNRM','9:GFDL-GOLD','10:CERFACS','11:AWI-FESOM','12:Kiel-ORCA05','13:CMCC-ORCA','14:NOC-ORCA','15:MOM-0.25'},'fontsize',13);
hh=text(11,10.5,{'1:AWI-FESOM','2:Bergen','3:CERFACS','4:CMCC','5:CNRM', ...
       '6:FSU-HYCOM','7:FSU-HYCOMv2','8:GFDL-GOLD', '9:GFDL-MOM','10:Kiel-ORCA05', ...
       '11:MOM0.25','12:MRI-A','13:MRI-F','14:NCAR','15:NOC',},'fontsize',14)
set(hh,'BackgroundColor','w')
printname=['paperfigs2/fram_volume_corr_low']
print(2,'-depsc2',printname)

figure(3)
imagescwithnan(flipud(fram_volume_corr_HP),jet,[.7 .7 .7])
set(gca,'yticklabel',{'14' '12' '10' '8' '6' '4' '2'})
caxis([0 1])
printname=['paperfigs2/fram_volume_corr_high']
print(3,'-depsc2',printname)

close all
marpcolor((fram_volume_corr_LP));shf
set(gca,'yticklabel',{'2' '4' '6' '8' '10' '12' '14'})
set(gca,'ytick',[2.5:2:16])                           
set(gca,'xtick',[2.5:2:16])
set(gca,'xticklabel',{'2' '4' '6' '8' '10' '12' '14'})
hh=text(11.5,6,{'1:AWI-FESOM','2:Bergen','3:CERFACS','4:CMCC','5:CNRM', ...
       '6:FSU-HYCOM','7:FSU-HYCOMv2','8:GFDL-GOLD', '9:GFDL-MOM','10:Kiel-ORCA05', ...
       '11:MOM0.25','12:MRI-A','13:MRI-F','14:NCAR','15:NOC',},'fontsize',14)
%set(hh,'BackgroundColor','w')
printname=['paperfigs2/fram_volume_corr_low_v2']
