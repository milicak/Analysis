...
m_pcolor(lon,lat,temp');shading interp;needJet2;
if(sec_depth==5)
caxis([-1 8])
...
printname=['paperfigs2/phc_temp_horizontal_section_' num2str(sec_depth)];
...
hold on
     ...
     set(gca,'fontsize',fontsize)
     set(gcf,'color','w');
printname=['paperfigs2/phc_salt_horizontal_section_' num2str(sec_depth)];
print(1,'-depsc2','-r150',printname)
export_fig(1,printname,'-eps','-r150');
close all
