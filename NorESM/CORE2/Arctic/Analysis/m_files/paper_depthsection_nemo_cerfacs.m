...
filename_u='/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/nemo-cerfacs/CERFACS_TSUV_decade.nc';
filename_v='/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/nemo-cerfacs/CERFACS_TSUV_decade.nc';
...
set(gcf,'color','w');
printname=['paperfigs2/nemo_cerfacs_uv_horizontal_section1_' num2str(sec_depth)];
...
m_grid('xtick',[-120 -60 0 60 120])
     ...
     set(gca,'fontsize',fontsize)
     set(gcf,'color','w');
%printname=['paperfigs/nemo_cerfacs_salt_horizontal_section_' num2str(sec_depth)];
printname=['paperfigs2/nemo_cerfacs_salt_horizontal_section_' num2str(sec_depth)];
print(1,'-depsc2','-r150',printname)
...
title('CERFACS')
m_grid('xtick',[-120 -60 0 60 120])
%printname=['paperfigs/nemo_ferfacs_temp_horizontal_section_' num2str(sec_depth)];
printname=['paperfigs2/nemo_cerfacs_temp_horizontal_section_' num2str(sec_depth)];
     fontsize=18;
     set(findall(gcf,'type','text'),'FontSize',fontsize)
     set(gca,'fontsize',fontsize)
     set(gcf,'color','w');
