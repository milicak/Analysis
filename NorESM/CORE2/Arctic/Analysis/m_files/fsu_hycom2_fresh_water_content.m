...
grid_file='/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/fsu-hycom2/bathy_2darea_fsu-hycom2.nc';
area=ncgetvar(grid_file,'area');
bathy=ncgetvar(grid_file,'bathy');
bathy3d=repmat(bathy,[1 1 12]);
...
save('matfiles/fsu_hycom2_fresh_water_content.mat','FWC','lon','lat')
