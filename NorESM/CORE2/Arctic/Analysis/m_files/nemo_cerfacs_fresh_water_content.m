...
grid_file='/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/nemo-cerfacs/CERFACS_cell_area.nc';
area=ncgetvar(grid_file,'Cell_area');
%depth=ncgetvar('/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/DATA/nemo-cerfacs/ORCA1_mesh_mask.nc','mbathy');
...
save('matfiles/nemo_cerfacs_fresh_water_content.mat','FWC','lon','lat')
