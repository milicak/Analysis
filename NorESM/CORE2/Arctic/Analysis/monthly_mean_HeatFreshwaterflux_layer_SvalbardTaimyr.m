...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/' expid '_heat_freshwater_layer_SvalbardTaimyr_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
%ncid=netcdf.create(['/work/milicak/RUNS/noresm/CORE2/Arctic/' expid '_heat_freshwater_layer_SvalbardTaimyr_monthly_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
