% this subroutine computes monthly mean idlage for the first month
clear all
...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/' expid '_idealage_first_month_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
