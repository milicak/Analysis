% this subroutine computes monthly mean temp for the first model month
clear all
...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/' expid '_temperature_first_month_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
