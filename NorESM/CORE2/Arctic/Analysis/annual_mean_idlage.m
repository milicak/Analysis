% this subroutine computes annual mean idlage
clear all
...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/Arctic/' expid '_idealage_annual_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
