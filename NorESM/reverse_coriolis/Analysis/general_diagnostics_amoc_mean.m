...
if(region==1)
  save_name = ['matfiles/Atlantic' expid '_moc_mean_years_' num2str(fyear) '_' num2str(lyear)];
elseif(region==2)
  save_name = ['matfiles/Pacific' expid '_moc_mean_years_' num2str(fyear) '_' num2str(lyear)];
elseif(region==3)
  save_name = ['matfiles/Global' expid '_moc_mean_years_' num2str(fyear) '_' num2str(lyear)];
end
%keyboard
save(save_name,'MOC_mean','lat','depth')
