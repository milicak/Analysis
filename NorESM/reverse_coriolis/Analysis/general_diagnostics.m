...
if(pmoc_time == true)
  ...
  % 3 for global_ocean
  region = 2;
  [pmoc pmoc_26_5 pmoc_45]=general_diagnostics_amoc_time(root_folder,expid,m2y,fyear,lyear,region);
end
...
if(moc_time == true)
  ...
  % 3 for global_ocean
  region = 3;
  [moc moc_26_5 moc_45]=general_diagnostics_amoc_time(root_folder,expid,m2y,fyear,lyear,region);
end
