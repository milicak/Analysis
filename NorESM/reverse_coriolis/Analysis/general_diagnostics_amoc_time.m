...
if(region==1)
  save_name = ['matfiles/Atlantic' project_name '_' amoc_info.name '_years_' amoc_info.years];
elseif(region==2)
  save_name = ['matfiles/Pacific' project_name '_' amoc_info.name '_years_' amoc_info.years];
elseif(region==3)
  save_name = ['matfiles/Global' project_name '_' amoc_info.name '_years_' amoc_info.years];
end
if(kk==1)
