% this subroutine computes pendatal mean saln
clear all
...
ncid=netcdf.create(['/bcmhsm/milicak/RUNS/noresm/CORE2/kepsilon/' expid '_salinity_annual_' num2str(fyear) '-' num2str(lyear2) '.nc'],'NC_CLOBBER');
