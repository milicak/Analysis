...
% Create netcdf file.
ncid=netcdf.create([expid '_zonal_mean_salinity_annual_' num2str(fyear) '-' num2str(lyear) '.nc'],'NC_CLOBBER');
...
szm_varid=netcdf.defVar(ncid,'s','float',[lat_dimid depth_dimid time_dimid]);
